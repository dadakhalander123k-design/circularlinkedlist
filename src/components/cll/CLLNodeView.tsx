...
export const CLLNodeView: React.FC<CLLNodeViewProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        onClick={onClick}
        className={`group flex flex-col rounded-xl border-2 shadow-xs transition-all duration-200 cursor-pointer overflow-hidden min-w-[130px] sm:min-w-[145px] ${
          isSelected
            ...
            {isEditingAddress ? (
              <form onSubmit={handleAddressSubmit} className="flex items-center gap-1 w-full mt-1">
                <input
                  ...
                  className="w-full px-1 py-0.5 text-[11px] font-mono font-bold bg-white dark:bg-[#0B1120] border border-blue-500 rounded text-center text-blue-600 focus:outline-hidden"
                />
                <button
                  type="submit"
                  onClick={(e) => e.stopPropagation()}
                  className="p-1 bg-blue-600 text-white rounded text-[10px] hover:bg-blue-700 cursor-pointer"
                  title="Apply Address"
                >
              ...
              <div className="flex items-center gap-1 font-mono">
                <span
                  ...
                  className={`text-[11px] font-bold px-1.5 py-0.5 rounded border transition-all ${
                    hasBrokenPointer
